      ...
      <div className="faq__container">
        ...
        <div className="faq__left">
          ...
          <h2 className="faq__heading">
            Common Questions About Our NYC Roofing Services
          </h2>
          <p className="faq__subtext">
            Find clear answers about our residential and commercial roofing, inspections,
            emergency repairs, estimates, licensing, and warranties across New York City.
          </p>
