    ...
    <section className="need-services" ref={sectionRef}>
      <div className="need-services__inner">
        <h2 className="need-services__heading">
          ...
          <br />in Manhattan or NYC?
        </h2>
        <p className="need-services__text">
          Call us at (212) 495-9840 or request a free on-site estimate — residential and commercial
          roofing <br />across Manhattan, Brooklyn, Queens, and The Bronx.
        </p>
