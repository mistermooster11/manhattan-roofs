    ...
    <footer className="footer">
      ...
      <div className="footer__top">
        <div className="footer__brand">
          <Link href="/">
            <Image
              src="/logos/manhattan-roofing_dark-background.png"
          ...
          <p className="footer__desc">
            <strong>Manhattan Roofing</strong> is an owner-operated roofing company with 30+ years
            of experience serving Manhattan and all five NYC boroughs. Flat roofs, shingle roofs,
            emergency repairs, and chimney work — free on-site estimates.
          </p>
      ...
      <div className="footer__bottom">
        <p className="footer__copyright">Copyright 2026 Manhattan Roofing. All rights reserved.</p>
