    ...
    <section className="services" ref={sectionRef}>
      ...
      <div className="services__header max-w-6xl! mx-auto">
        ...
        <h2 className="services__heading">
          Professional Roofing Services Across Manhattan &amp; All NYC Boroughs
        </h2>
        <p className="services__subtext">
          Residential roofing, commercial roofing, inspections, chimney repair, and emergency
          repairs — free on-site estimates for every job.
        </p>
      </div>
