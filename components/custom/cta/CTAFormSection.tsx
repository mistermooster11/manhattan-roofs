...
export default function CTAFormSection() {
  ...
  const WHY_RIGHT = [
    "Flat, shingle, metal, and slate roofs",
    "Chimney repair and waterproofing",
    "Storm damage and insurance work",
    "Honest pricing, written warranty",
  ];
    ...
    <section className="cta-form" ref={sectionRef}>
      <div className="cta-form__container">
        ...
        <div className="cta-form__left p-10!">
          <div className="cta-form__eyebrow hidden md:block">Free On-Site Estimates</div>
          <h2 className="cta-form__heading hidden md:block">
            Get a Free Roofing Estimate <br />from Manhattan&apos;s Trusted Pros
          </h2>
          <h2 className="cta-form__heading block md:hidden">
            Get in touch
          </h2>
          <p className="cta-form__subtext hidden md:block">
            Free estimates — No obligation. Emergency service available.
            <br />Call (212) 495-9840 or fill out the form below.
          </p>
        ...
        <div className="cta-form__right">
          ...
          <p className="cta-form__text">
            Whether you need a routine inspection, a full roof replacement, or an emergency repair
            after a storm, Manhattan Roofing delivers fast, professional service across all NYC boroughs.
          </p>
          <p className="cta-form__text">
            We work on flat roofs, shingle roofs, metal roofs, and slate roofs for residential and
            commercial properties. Every estimate is free, every quote is in writing, and every job
            is backed by a workmanship warranty.
          </p>
