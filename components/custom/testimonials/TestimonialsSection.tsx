    ...
    <section className="testimonials" ref={sectionRef}>
      <div className="testimonials__container">
        ...
        <div className="testimonials__header">
          <div className="testimonials__eyebrow">What Our Clients Say</div>
          <h2 className="testimonials__heading">Trusted When It Matters Most</h2>
          <p className="testimonials__subtext">
            NYC property owners and building managers trust Manhattan Roofing for fast response,
            quality workmanship, and honest pricing — on flat roofs, shingle roofs, emergency
            repairs, and chimney work across all five boroughs.
          </p>
        </div>
